...
public:
  ...
  virtual std::vector<Point3D> sample(const size_t pointCount) const = 0;
};
...
public:
  ...
  std::vector<Point3D> sample(const size_t pointCount) const override;
...
public:
  ...
  std::vector<Point3D> sample(const size_t pointCount) const;
